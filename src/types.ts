export type User = { id:string; username:string; email?:string; role:'admin'|'user'; active:number; createdAt:string; updatedAt:string }
...
export type Report = {id:string;title:string;description:string;eventDate:string;latitude:number;longitude:number;address:string;typeId:string;authorId:string;author:string;dossierId:string|null;createdAt:string;updatedAt:string}
